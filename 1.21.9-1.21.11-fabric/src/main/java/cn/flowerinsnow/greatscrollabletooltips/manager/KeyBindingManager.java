...
public class KeyBindingManager {
    private static final Lazy<KeyMapping.Category> CATEGORY = new Lazy<>(() -> KeyMapping.Category.register(ResourceLocation.fromNamespaceAndPath(GreatScrollableTooltips.MODID, "name")));
