...
minecraft {
    ...
    mappings(project.findProperty("mapping_channel") as String, project.findProperty("mapping_version") as String)
...
dependencies {
    ...
    implementation("cn.flowerinsnow.greatscrollabletooltips:common:${project.findProperty("version_common_module")}")
    jarJar("cn.flowerinsnow.greatscrollabletooltips:common:[${project.findProperty("version_common_module")}]")
